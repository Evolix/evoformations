...
\usepackage{fancyhdr}
\pagestyle{fancy}
\lhead{\textcolor{gris50}{\scriptsize{Administration Linux Apache PHP MySQL}}}
\rhead{\textcolor{gris50}{\scriptsize{Formation Evolix}}}

\lfoot{\scriptsize{\thepage}}
\cfoot{\textcolor{gris50}{\scriptsize{Evolix / www.evolix.fr / info@evolix.fr / Octobre 2014}}}
...
\author{Evolix}
\title{Administration Linux Apache PHP MySQL}
\date{Octobre 2014}
...
~\\
Focus sur Apache, PHP, MySQL\\
~\\
\normalsize{Evolix - Octobre 2014}\\
...
~\\
Copyright (c) 2004,2005,2006,2007,2008,2009,2010,2011,2012,2013,2014 Evolix, Grégory Colpart, Sébastien Dubois, Romain Dessort, Arnaud André et Alexandre Anriot\\
~\\
